...
var Product = /** @class */ (function () {
    ...
    Product.prototype.setPrice = function (amountEUR) {
        var _this = this;
        currency_converter_1.default.availableCurrencies.forEach(function (currencyCode) {
            _this.addPrice(new price_1.default(currencyCode, roundToTwoDecimals(currency_converter_1.default.convertFromEUR(amountEUR, currencyCode))));
        });
        return this;
    };
